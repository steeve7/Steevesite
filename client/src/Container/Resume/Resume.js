...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"High School "}
        subHeading={"Uwani Secondary School Enugu"}
        fromDate={"2010"}
        toDate={"2016"}
      />
      <ResumeHeading
        heading={"University of Nigeria, Nsukka"}
        subHeading={"BSC STATISTICS"}
        fromDate={"2016"}
        toDate={"2021"}
      />
      ...
      <ResumeHeading
        ...
        subHeading={"Ministry Of Science And Technogy. Ogun Lagos State"}
        fromDate={"2021"}
        toDate={"2022"}
      />
    </div>,
    ...
    <div className="resume-screen-container" key="work-experience">
      <div className="experience-container">
        ...
        <div className="experience-description">
          <span className="resume-description-text">
            - Developed an business website for client with the dashboard for
    ...
    return resumeBullets.map((bullet, index) => (
      ...
      >
        <img
          ...
          src={require(`../../assest/Resume/${bullet.logoSrc}`)}
          alt="B"
        />
